...
const Mainbody = () => {
  ...
  const authorization = localStorage.getItem("kye");
  if (!authorization) {
  ...
  const Components = [
    {
      path: "/adminpanel/component/Category",
      page: "Category"
    },
    {
      ...
      <Box sx={{ display: 'flex', justifyContent: 'end' }}>
        ...
        >
          ...
          <Box sx={{ padding: "20px 0px 70px" }}>
            <List >
              <ListItem sx={{ padding: "0px 20px" }} onClick={() => { goon("/adminpanel") }}>
                <ListItemButton >
              ...
              <Collapse in={expand[1]} timeout="auto" unmountOnExit>
                <List component="div" disablePadding dense>
                  {Components.map((component) => (
                    <ListItem key={component.page} disablePadding onClick={() => { goon(component.path) }}>
              ...
              <ListItem sx={{ padding: "0px 20px" }}>
                <ListItemButton onClick={() => setExpand({ ...expand, 2: !expand[2] })}>
                  <ListItemIcon sx={{ minWidth: "30px" }}>
                    <BsJournalText />
                  </ListItemIcon>
              ...
              <ListItem sx={{ padding: "0px 20px" }}>
                <ListItemButton onClick={() => setExpand({ ...expand, 3: !expand[3] })}>
                  <ListItemIcon sx={{ minWidth: "30px" }}>
              ...
              <ListItem sx={{ padding: "0px 20px" }}>
                ...
                <ListItemButton onClick={() => setExpand({ ...expand, 4: !expand[4] })}>
                  <ListItemIcon sx={{ minWidth: "30px" }}>
                    <BsBarChart />
                  </ListItemIcon>
              ...
              <ListItem sx={{ padding: "0px 20px" }}>
                <ListItemButton onClick={() => setExpand({ ...expand, 5: !expand[5] })}>
                  <ListItemIcon sx={{ minWidth: "30px" }}>
                    <BsGem />
                  </ListItemIcon>
        ...
        <Main open={open} sx={{ maxWidth: "100%" }}>
          <Switch>
            ...
            <Route path="/adminpanel/component/Category">
              <CategoryPage />
            </Route>
            <Route path="/adminpanel/component/Blog" >
              <Blog />
            </Route>
            <Route path="/adminpanel/component/Blog/details">
              <Blogdetails />
            </Route>
            <Route path="/adminpanel/user/profile">
              <Profile />
            </Route>
            <Route path="/adminpanel/page/contact">
              <Contact />
            </Route>
          </Switch>
